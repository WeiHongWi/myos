...
struct fat_private
{
    ...
    struct stream* cluster_read_stream;
    // Used to stream the file allocation table
    struct stream* fat_read_stream;


    // Used in situations where we stream the directory
    struct stream* directory_stream;
};
