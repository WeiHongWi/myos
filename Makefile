FILES = ./build/kernel.asm.o ./build/kernel.o ./build/fs/file.o ./build/fs/fat/fat.o ./build/disk/stream.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o ./build/disk/disk.o ./build/fs/path_parser.o ./build/string/string.o
INCLUDES = -I./src
...
./build/fs/fat/fat.o: ./src/fs/fat/fat.c
	i686-elf-gcc $(INCLUDES) -I./src/fs $(FLAGS) -std=gnu99 -c ./src/fs/fat/fat.c -o ./build/fs/fat/fat.o
